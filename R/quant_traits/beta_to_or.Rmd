---
title: "Converting linear regression to a logistic regression using only summary stats"
output:
...
Many traits that we might like to include in the basis are continuous and therefore we only have access to summary statistics for a linear regression of the form $$ Y = \alpha + \beta X + \epsilon$$
