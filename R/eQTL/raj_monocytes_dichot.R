...
raj_cd4 <- readRDS("/scratch/ob219/as_basis/raj_cd14_ind_analysis//raj-cd14-basis_genotypes.RDS")
...
computeORMat <- function(Y,G,n0=212,n1=210){
...
computeSEORMat <- function(Y,G,n0=212,n1=210){
  if(is.matrix(Y) & is.matrix(G))
    stop("Both X and Y are matrices in computeORMat")
  unx <- colSums((1-Y) * G)
  ex <- colSums(Y * G)
...
bsnps <- fread("/scratch/ob219/as_basis/support_tab/as_basis_snp_support_cd14_eQTL.tab")
...
snp.ids <- sdt$pid
saveRDS(snp.ids,file="/home/ob219/scratch/as_basis/raj_cd14_dichot_analysis/snps.RDS")
...
saveRDS(g.mat,file="/home/ob219/scratch/as_basis/raj_cd14_dichot_analysis/gt_matrix.RDS")

ot.mat <- as.matrix(pheno.median[,8:ncol(pheno.median)])
saveRDS(ot.mat,file="/home/ob219/scratch/as_basis/raj_cd14_dichot_analysis/outcome_matrix.RDS")
...
saveRDS(shrink.DT,file="/home/ob219/scratch/as_basis/raj_cd14_dichot_analysis/shrink.RDS")
basis.mat.emp <- create_ds_matrix(basis.DT,shrink.DT,'emp')
## need to add control where beta is zero
basis.mat.emp<-rbind(basis.mat.emp,control=rep(0,ncol(basis.mat.emp)))
pc.emp <- prcomp(basis.mat.emp,center=TRUE,scale=FALSE)
## save this
saveRDS(pc.emp,file="/home/ob219/scratch/as_basis/raj_cd14_dichot_analysis/pc.RDS")
