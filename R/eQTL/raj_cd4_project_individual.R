...
input.dir <- '/scratch/ob219/as_basis/raj_cd4_ind_analysis/eqtl_ind_proj_2_0.01_2500_1e+06'
...
save_plot("~/tmp/raj_cd4_qq.pdf",gpl,base_height=5)
...
saveRDS(rbindlist(anno),"/home/ob219/scratch/as_basis/raj_cd4_ind_analysis/regression_analysis/top_genes.RDS")
