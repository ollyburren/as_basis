...
getSims<-function(gwas=c('ill.t1d','aff.t1d'),sim_size=sim.size){
...
pw.dir<-'/home/ob219/scratch/as_basis/ai_aff_basis_sims/'
...
saveRDS(empirical_confidence_intervals,file='/home/ob219/scratch/as_basis/figure_data/analysis1_ill_basis_ci.RDS')
